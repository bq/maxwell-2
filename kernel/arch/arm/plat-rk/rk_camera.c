...
static int rk_sensor_ioctrl(struct device *dev,enum rk29camera_ioctrl_cmd cmd, int on)
{
	...
	char *cam_dev_name[30];
	char *camera_sid130B, *camera_ov5640, *camera_ov2659, *camera_ov2655;
	...
	switch (cmd)
 	{
 		case Cam_Power:
		{
			if (sensor_ioctl_cb.sensor_power_cb) {
				strcpy(cam_dev_name,dev_name(dev));
				camera_sid130B = strstr(cam_dev_name,"sid130B");
				camera_ov5640 = strstr(cam_dev_name,"ov5640");
				camera_ov2655 = strstr(cam_dev_name,"ov2655");
				camera_ov2659 = strstr(cam_dev_name,"ov2659");
				if(camera_sid130B != NULL || camera_ov5640 != NULL || camera_ov2659 != NULL
					|| camera_ov2655 != NULL)
